...
<?php if ( $latestProducts[0] ): ?>
    <?php foreach ( $latestProducts as $product ): ?>
        <div class="col-xs-8 col-sm-4 col-md-4 col-lg-4">
            <div class="thumbnail">
                <a href="/product/<?= $product->code; ?>" class="thumbnail" target="_blank">
                ...
                <div class="caption">
                    ...
                    <p>
                        <a href="/product/<?= $product->code; ?>" class="btn btn-primary" role="button" target="_blank"><span class="glyphicon glyphicon-eye-open" aria-hidden="true"> </span> Просмотр</a>
